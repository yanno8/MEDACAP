                                                            ...
                                                            <div id="kt_modal_update_user_user_info"
                                                                ...
                                                                <div class='d-flex flex-column mb-7 fv-row'>
                                                                  ...
                                                                  <select name='level' aria-label='Select a Country' data-placeholder='Niveau de la formation' 
                                                                      class='form-select form-select-solid fw-bold'>
                                                                          ...
                                                                          ?>
                                                                              <option value="<?php echo htmlspecialchars($level); ?>" <?php echo ($level == $vehicle['level']) ? 'selected' : ''; ?>><?php echo htmlspecialchars($label); ?></option>
                                                                          <?php 
                                                                          endforeach; 
                                                                          ?>
                                                                  </select>
                                                                ...
                                                                <div class="d-flex flex-column mb-7 fv-row">
                                                                    ...
                                                                    <select name="quizze[]" multiple aria-label="Select a Country"
                                                                        ...
                                                                        $vehicleDatas = []; 
                                                                        foreach ($vehicle['quizzes'] as $bra) {
