        ...
        if (isset($exam)) {
            ...
            if (count($questionsTag) != $exam->total) {
                ...
                if ($exist) {
                    ...
                    $resultT = $results->insertOne($resultT);
                }
                ...
                if (isset($manager['lastName'], $technician['firstName'], $technician['lastName'], $level)) {
                    ...
                    $message = '<p>Bonjour M. ' . $managerLastName . ',</p>
                                ...
                                a complété son <strong>QCM Tâche Professionnelle niveau ' . $levelEscaped . '</strong>, 
                    ...
                    // Sujet de l'e-mail
                    $subject = 'Confirmation de réception du QCM Tâche Professionnelle niveau ' . $levelEscaped . ' de ' . $technicianFirstName . ' ' . $technicianLastName;

                    // Envoyer l'e-mail
                    $sendMail = sendMailQCMDone($manager['email'], $subject, $message);
                }
