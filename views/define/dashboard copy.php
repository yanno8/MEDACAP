                ...
                <div class=" container-xxl ">
                    ...
                    <div class="row g-6 g-xl-9 mb-6 mb-xl-9">
                        ...
                        <div style="margin-top: 55px; margin-bottom : 25px">
                            <div>
                                <h6 class="text-dark fw-bold my-1 fs-2">
                                    <?php echo 'Validation des Plans de Formations par la Filiale' ?>
                                </h6>
                            </div>
                        </div>
                        <!--end::Title-->
                            ...
                            <div class="card h-100 ">
                                ...
                                <div class="card-body d-flex justify-content-center text-center flex-column p-8">
                                    ...
                                    <div
                                        class="fs-lg-1hx fs-2x fw-bold text-gray-800 d-flex justify-content-center text-center">
                                        <div class="min-w-70px" data-kt-countup="true" data-kt-countup-separator=" "
                                            data-kt-countup-value="<?php echo count($trainingSelected); ?>">
                                        </div>
                                    </div>
                                    <!--end::Animation-->
                                    <!--begin::Title-->
                                    <div class="fs-5 fw-bold mb-2">
                                        <?php echo 'Place(s) demandée(s)' ?> </div>
                                    <!--end::Title-->
                                    <!--end::Name-->
                                </div>
                                <!--end::Card body-->
                            ...
                            <div class="card h-100 ">
                                ...
                                <div class="card-body d-flex justify-content-center text-center flex-column p-8">
                                    ...
                                    <div
                                        class="fs-lg-1hx fs-2x fw-bold text-gray-800 d-flex justify-content-center text-center">
                                        <div class="min-w-70px" data-kt-countup="true" data-kt-countup-separator=" "
                                            data-kt-countup-value="<?php echo count($trainingTechSelected) ?>">
                                        </div>
                                    </div>
                                    <!--end::Animation-->
                                    <!--begin::Title-->
                                    <div class="fs-5 fw-bold mb-2">
                                        <?php echo 'Session(s) de formation' ?> </div>
                                    <!--end::Title-->
                                    <!--end::Name-->
                                </div>
                                <!--end::Card body-->
                            ...
                            <div class="card h-100 ">
                                ...
                                <div class="card-body d-flex justify-content-center text-center flex-column p-8">
                                    ...
                                    <div
                                        class="fs-lg-1hx fs-2x fw-bold text-gray-800 d-flex justify-content-center text-center">
                                        <div class="min-w-70px" data-kt-countup="true" data-kt-countup-separator=" "
                                            data-kt-countup-value="<?php echo (count($trainingTechSelected) * 5); ?>">
                                        </div>
                                    </div>
                                    <!--end::Animation-->
                                    <!--begin::Title-->
