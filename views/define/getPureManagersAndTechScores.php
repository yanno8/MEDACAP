<?php
/**
 * getPureManagersAndTechScores.php
 *
 * Objectif :
 *  1) Lister les managers actifs qui n'ont que des Techniciens sous leur responsabilité
 *     (aucun manager ne pointe vers eux).
 *  2) Pour chacun de ces managers, récupérer la liste de ses techniciens.
 *  3) Pour chaque technicien, récupérer les scores factuels et déclaratifs globaux
 *     par niveau et par spécialité (exploite la classe ScoreCalculator).
 */

// Chargement de l'autoload et des classes nécessaires
