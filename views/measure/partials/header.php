                               ...
                               <div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
                                    ...
                                    if ($_SESSION["profile"] == "Manager") {
                                        foreach ($menuStructure as $groupName => $items) {
                                            ...
                                            if ($_SERVER["REQUEST_URI"] != "/medacap/views/measure/dashboard" &&
                                                $_SERVER["REQUEST_URI"] != "/medacap/views/measure/profile?id=" . $_SESSION["id"] &&
                                                $_SERVER["REQUEST_URI"] != "/medacap/views/measure/edit-delet" &&
                                                $_SERVER["REQUEST_URI"] != "/medacap/views/measure/collaborators" &&
                                                $_SERVER["REQUEST_URI"] != "/medacap/views/measure/editDeletCollaborator" &&
                                                $_SERVER["REQUEST_URI"] != "/medacap/views/measure/createCollaborator" &&
                                                $_SERVER["REQUEST_URI"] != "/medacap/views/measure/allocationManager" &&
                                                $_SERVER["REQUEST_URI"] != "/medacap/views/measure/congrat" &&
                                                $_SERVER["REQUEST_URI"] != "/medacap/views/measure/userManagerList" &&
                                                $_SERVER["REQUEST_URI"] != "/medacap/views/measure/userManagerResults" &&
                                                $_SERVER["REQUEST_URI"] != "/medacap/views/measure/testSavoir" && 
                                                $_SERVER["REQUEST_URI"] != "/medacap/views/measure/testSavoirFaire" &&
                                                $_SERVER["REQUEST_URI"] != "/medacap/views/measure/userQuizDeclaratif?test=" . $_GET["test"] . "&level=" . $_GET["level"] . "&id=" . $_GET["id"] && 
                                                $_SERVER["REQUEST_URI"] != "/medacap/views/measure/userQuizFactuel?test=" . $_GET["test"] . "&level=" . $_GET["level"] . "&id=" . $_GET["id"]) {
                                                if ($groupName == "évaluer vos collaborateurs") {
                                                    // Afficher le nom du groupe
                                                    echo '<div class="menu-content">';
                                                    echo '<span class="fw-bold text-black text-uppercase fs-70">' . htmlspecialchars($groupName) . '</span>';
                                                    echo '</div>';
                                                    ...
                                                    foreach ($items as $item) {
                                                        ...
                                                        if ($key == 'user_evaluation') {
                                                            echo '<a class="menu-link" href="' . htmlspecialchars($item['url']) . '?test=' . $_GET['test'] . '&level=' . $_GET['level'] . '&id=' . $_GET['id'] . '&user=' . $_GET['user'] . '">';
                                                        } else {
                                                            echo '<a class="menu-link" href="' . htmlspecialchars($item['url']) . '">';
                                                        }
                                                        echo '<span class="menu-icon">';
                                                    ...
                                                    echo '</div>';
                                                    echo '</div>';
                                                } else if ($groupName == 'Mesure des compétences') {
                                                    // Afficher le nom du groupe
                                                    echo '<div class="menu-content">';
                                                    echo '<span class="fw-bold text-black text-uppercase fs-70">' . htmlspecialchars($groupName) . '</span>';
                                                    echo '</div>';
                                                    ...
                                                    foreach ($items as $item) {
                                                        ...
                                                        if ($key == 'list_qcm_connaissances' || $key == 'list_qcm_tache_pro') {
                                                            echo '<div class="menu-item">';
                                                            echo '<a class="menu-link" href="' . htmlspecialchars($item['url']) . '">';
                                                            echo '<span class="menu-icon">';
                                                            if ($iconType === 'ki_duotone') {
                                                ...
                                                if ($_SERVER["REQUEST_URI"] != "/medacap/views/measure/dashboard" &&
                                                    ...
                                                    $_SERVER["REQUEST_URI"] != "/medacap/views/measure/userManagerList" &&
                                                    $_SERVER["REQUEST_URI"] != "/medacap/views/measure/userManagerResults") {
                                                    if ($groupName == "Mesure des compétences") {
                                                        // Afficher le nom du groupe
                                                        echo '<div class="menu-content">';
                                                        echo '<span class="fw-bold text-black text-uppercase fs-70">' . htmlspecialchars($groupName) . '</span>';
                                                        echo '</div>';
                                                        if ($_SERVER["REQUEST_URI"] != "/medacap/views/measure/userQuizFactuel?test=" .  $_GET["test"] . "&level=" . $_GET["level"] . "&id=" . $_GET["id"]) {
                                                            // Afficher les fonctionnalités du groupe
                                                            foreach ($items as $item) {
                                                                // Vérifiez la key
                                                                $key = $item['key'] ?? '';
                                                                ...
                                                                if ($key == 'qcm_tache_pro' || $key == 'list_qcm_connaissances') {
                                                                    echo '<div class="menu-item">';
                                                                    if ($key == 'qcm_tache_pro') {
                                                                        echo '<a class="menu-link" href="' . htmlspecialchars($item['url']) . '?test=' . $_GET['test'] . '&level=' . $_GET['level'] . '&id=' . $_GET['id'] . '">';
                                                                    } else {
                                                                        echo '<a class="menu-link" href="' . htmlspecialchars($item['url']) . '">';
                                                                    }
                                                                    echo '<span class="menu-icon">';
                                                        ...
                                                        if ($_SERVER["REQUEST_URI"] != "/medacap/views/measure/userQuizDeclaratif?test=" . $_GET["test"] . "&level=" . $_GET["level"] . "&id=" . $_GET["id"]) {
                                                            // Afficher les fonctionnalités du groupe
                                                            foreach ($items as $item) {
                                                                // Vérifiez la key
                                                                $key = $item['key'] ?? '';
                                                                ...
                                                                if ($key == 'qcm_connaissances' || $key == 'list_qcm_tache_pro') {
                                                                    echo '<div class="menu-item">';
                                                                    if ($key == 'qcm_connaissances') {
                                                                        echo '<a class="menu-link" href="' . htmlspecialchars($item['url']) . '?test=' . $_GET['test'] . '&level=' . $_GET['level'] . '&id=' . $_GET['id'] . '">';
                                                                    } else {
                                                                        echo '<a class="menu-link" href="' . htmlspecialchars($item['url']) . '">';
                                                                    }
                                                    ...
                                                    if ($groupName == "Mesure des compétences") {
                                                        ...
                                                        foreach ($items as $item) {
                                                            ...
                                                            if ($key == 'list_qcm_tache_pro' || $key == 'list_qcm_connaissances') {
                                                                echo '<div class="menu-item">';
                                                                echo '<a class="menu-link" href="' . htmlspecialchars($item['url']) . '">';
                                                                echo '<span class="menu-icon">';
                                                                if ($iconType === 'ki_duotone') {
                                        ...
                                        foreach ($menuStructure as $groupName => $items) {
                                            if ($groupName == '') {        
                                                ...
                                                foreach ($items as $item) {
                                                    ...
                                                    echo '<div class="menu-item">';
                                                    echo '<a class="menu-link" href="' . htmlspecialchars($item['url']) . '?id=' . $_SESSION['id'] . '">';
                                                    echo '<span class="menu-icon">';
                                                    if ($iconType === 'ki_duotone') {
                                                        echo '<i class="' . htmlspecialchars($item['icon']) . ' fs-2">';
                                                        echo '<span class="path1"></span>';
