...
<!--begin::Title-->
<title><?php echo $list_test_qcm ?> | CFAO Mobility Academy</title>
<!--end::Title-->
                                ...
                                <tbody class="fw-semibold text-gray-600" id="table">
                                    ...
                                    <tr class="odd">
                                        ...
                                        <td class="text-center">
                                            ...
                                            <?php if ($examJuFac) { ?>
                                                    <a href="./userQuizFactuel?test=<?php echo $allocateFacJu[
                                                        "test"
                                    ...
                                    <tr class="odd">
                                        ...
                                        <td class="text-center">
                                            ...
                                            <?php if ($examSeFac) { ?>
                                                    <a href="./userQuizFactuel?test=<?php echo $allocateFacSe[
                                                        "test"
                                    ...
                                    <tr class="odd">
                                        ...
                                        <td class="text-center">
                                            ...
                                            <?php if ($examExFac) { ?>
                                                    <a href="./userQuizFactuel?test=<?php echo $allocateFacEx[
                                                        "test"
